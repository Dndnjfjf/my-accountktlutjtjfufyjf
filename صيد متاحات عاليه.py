...
fast=20 
bot=telebot.TeleBot(token=input("خلي التوكن وروح للبوت ارسل /start  : "),threaded=20)
def date_l7n(Id):
 try:
...
def hsn1(message):
    ...
    help=telebot.types.InlineKeyboardButton(text="التعليمات مهم جداً",callback_data="help") 
    owner3=telebot.types.InlineKeyboardButton(text="Acc Owner",url="https://t.me/+KzydxjYyLZNiMzNi")
    adTYpes=telebot.types.InlineKeyboardMarkup(row_width=2)
    adTYpes.add(but1,but11,but12,but13,help,owner3) 
...
def call1(call):
    if call.data=="but1":
        ...
        help_text = """
**1 : طريقة صيد انستا عالي :**

تسحب لستة نفس هذا الشرح لأن إذا تسحب لستة من متابعين أو عشوائي الصيد ما راح يصير قوي
لازم تشوف الشرح كامل علمود تفهم شلون تجيب الحسابات إلي تحتوي على لستة قوية  ومن وين تسحب من ليتابعهم لو من المتابعين وراح تعرف بعد هواي اشياء مهمة
ولازم تسحب أقل شي 30k لستة علمود تصيد صيد عالي نفس الصيد إلي اصيدة

[رابط الشرح](https://youtu.be/XawixVpYCTs?si=LL6zOtHXJlI0T8Cu)

**2:**

من تسحب لستة تفحصها بأي أداة فحص لستة 

لحد الآن أقوى أداة فحص موجودة هية الأداة هاي إلي مشغلها

**ملاحظة**

قبل لا تشغل الأداة لازم تشغل في بي إن على إسبانيا وإذا انحظرت من دولة إسبانيا شغل في بي إن على النرويج

**شلون تعرف أنت محضور :**
إذا ضل يصيد متاحات هواي ويدز فقط الايميل ويكلك على الريست
dont link

يعني أنت محضور ف جرب على غير دولة إلي هية النرويج

وإذا انحظرت من الدولتين احذف ألفي بي إن وأرجع نزلة راح ينطيك غير بروكسي على كل دولة
...
فقط خلي توكن وروح للبوت أرسل /start واختار الفحص إلي تريدة جيميل لو هوتميل لو اوتلوك لو aol
اختار جيميل أفضل شي لأن باقي الدومينات ما بيهة صيد عالي

من تختار جيميل أرسل اللستة على شكل ملف (اللستة إلي سحبتها من الشرح )

وانتظر شوي راح يبدي يفحص

**ملاحظة**: إذا تأخر بإرسال الصيد انتظر وكلشي لا تسوي انتظرة يكمل فحص اللستة  كاملة إذا ما صادلك 10 حسابات أو أكثر يعني أنت محضور ولازم تغير الدولة
من تريد تغير الدولة لازم تطفي الأداة كاملة وتغير الدولة وترجع تشغل الأداة

**3 : حل المشاكل :**

إذا طلعلك  كلام وما ينطيك خيارات السحب من تريد تسحب لستة يعني حسابك صار بي تقيد مؤقت أنت أدخل على حسابك واضغط تجاهل

مرات يطلعك من الحساب يكلك من الممكن تم تغير كلمة السر أنت ارجع أدخل على حسابك بنفس كلمة السر وراح يدخلك  ومن يدخلك هم راح يكلك لمنع حدوث تقيد مؤقت على حسابك....
أنت اضغط تجاهل
وأرجع اسحب
وإذا طلعلك كلام غير الكلام إلي بالصورة يعني اليوزر إلي تريد تسحب من عندة يوزر ما موجود

**4 : هاي النقطة إلي ما يعرف :**

**1:**

**شلون يسحب المتاح :**

[رابط شرح سحب متاح](https://youtu.be/yiL6J0DwK_s?si=gHPXXzf--W9r-tAB)

**2:**

**شلون يستخرج توكن وايدي خاص للصيد:**

[شرح استخراج توكن وايدي](https://youtu.be/tRLq1KfZdfU?si=bvcskQyzryYcoQZd)
"""
...
print(".")
print(".")
print("شغل في بي ان vpnify علمود ما تنحظر من الفحص(على دولة اسبانيا )")
